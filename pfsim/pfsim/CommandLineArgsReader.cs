...
{     
    ...
    {         
        ...
        protected string _keyLeadingPattern;   
        ...
        public CommandLineArgReader(string[] args, string keyLeadingPattern)         
        {             
        ...
        public CommandLineArgReader(string[] args) : this(args, null)         
        {         
        }           
